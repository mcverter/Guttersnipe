...
<html style="height: 100%">
    <head lang="en">
    <meta charset="UTF-8">
        <title>Angular Grid - A Data Grid for AngularJS</title>
        ...
        <meta property="og:image" content="http://www.angulargrid.com/images/angular-grid.png"/>
...
<!--
                    ...
                    <div class="col-md-6" style="text-align: center;">
                        ...
                        <h2 style="font-style: italic; color: #404040; font-weight: bold;">
...
<!--
                        ...
                        <div style="margin-top: 30px;">
                            <div class="col-md-12" style="text-align: center;">
                                <a class="btn btn-primary header-button" href="http://www.angulargrid.com/dist" role="button">
...
-->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <!--<h2>Introducing Angular Grid</h2>-->
                    <p>
                        Feature rich, light weight, minimal footprint, no external dependencies.
                    </p>
                    <p>
                        People use ag-Grid over other free and paid grids because it's
                        <b>faster, more stable and better written</b>.
                    </p>
                </div>

                <div class="col-md-6" style="text-align: center">

                    <span style="padding: 10px; display: inline-block;"><a href="/example-native-javascript-grid/index.php">Plain Javascript</a></span>
                    <span style="padding: 10px; display: inline-block;"><a href="/angular-grid-getting-started/index.php">Angular 1.x</a></span>
                    <br/>
                    <span style="padding: 10px; display: inline-block;"><a href="/example-angular-2/index.php">Angular 2.0</a></span>
                    <span style="padding: 10px; display: inline-block;"><a href="/example-web-component-grid/index.php">Web Components</a></span>

<!--                        <table>
                            <tr>
                                <td>
                                    <li>
                                        <a href="/example-html5-datagrid/index.php">Plain Javascript</a>
                                    </li>
                                    <li>
                                        <a href="/example-html5-datagrid/index.php">Angular 1.x</a>
                                    </li>
                                </td>
                                <td>
                                    <li>
                                        <a href="/example-html5-datagrid/index.php">Angular 2.0</a>
                                    </li>
                                    <li>
                                        <a href="/example-html5-datagrid/index.php">Web Components</a>
                                    </li>
                                </td>
                            </tr>
                        </table>-->
...
<!--
                    <li><b>AngularJS 1.x</b>: As an AngularJS 1.x Directive. <a href="/example-html5-datagrid/index.php">learn more...</a></li>
                    <li><b>AngularJS 2.0</b>: As an AngularJS 2.0 Component. <a href="/example-html5-datagrid/index.php">learn more...</a></li>
                    <li><b>Web Components</b>: As a future Web Component. <a href="/example-html5-datagrid/index.php">learn more...</a></li>
                    <li><b>Plain Javascript</b>: Just using Javascript, no framework needed. <a href="/example-html5-datagrid/index.php">learn more...</a></li>
                        </ul>
-->
                </div>
            </div>
...
<!--
            <div class="row">
                <div class="col-md-3">
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Column Pinning</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Column Resizing</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Data Sorting</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Data Editing</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Value Getters</span><br/>
                </div>
                <div class="col-md-3">
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Quick Search</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Advanced Filtering</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Row Grouping</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Row Aggregation</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Checkbox Selection</span><br/>
                </div>
                ...
                <div class="col-md-3">
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Printable</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> API</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Pagination</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Infinite Scrolling</span><br/>
                    <span class="feature"><i class="fa fa-check-circle-o"></i> Expressions</span><br/>
                </div>
...
<script src="./dist/angular-grid.min.js?ignore=notused8"></script>
<link rel="stylesheet" type="text/css" href="./dist/angular-grid.min.css?ignore=notused8">
...
<link href="example-data-grid/basic.css?ignore=notused8" rel="stylesheet">
<link href="example-account-report/account.css?ignore=notused8" rel="stylesheet">

<script src="example-data-grid/basic.js?ignore=notused8"></script>
