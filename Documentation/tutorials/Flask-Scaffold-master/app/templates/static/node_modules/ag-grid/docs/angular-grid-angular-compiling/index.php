...
<div>
    ...
    <p/>
    Angular is great. The author of ag-Grid uses Angular for his large projects.
    <p/>
    ...
    To maximise the performance of ag-Grid, it does not use Angular to render it's
