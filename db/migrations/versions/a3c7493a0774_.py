...
Revision ID: a3c7493a0774
Revises: None
Create Date: 2017-03-16 13:02:33.871744

"""

# revision identifiers, used by Alembic.
revision = 'a3c7493a0774'
down_revision = None
...
def upgrade():
    ...
    sa.Column('description_how', sa.Text(), nullable=True),
    sa.Column('description_what', sa.Text(), nullable=True),
    sa.Column('notes', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['main_type_id'], ['main_type.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
