...
import {RenderBSTextField, RenderCalendarField} from '../create-wizard/renderField';
import Button from 'react-bootstrap/lib/Button';


const TimeCreate = ({handleSubmit, previousPage, headline}) => (
  <form onSubmit={handleSubmit}>
    <Field name="time_calendar" component={RenderCalendarField} label="Schedule of Shareable"  headline={headline} />
