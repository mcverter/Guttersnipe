/**
* @class HeatMapCtrl (Controller):
      Puts data on the scope for ../views/heat-map.html
      Page allows user to view Finance Activity on GoogleMaps
*/
(function (angular, app, _) {
  'use strict';

  app.controller('HeatMapCtrl', ['$log', '$debug', '$scope', '$geoJson', '$googleMaps', '$element', '$window',
    function ($log, $debug, $scope, $geoJson, $googleMaps, $element, $window) {
  ...
  .controller('HeatMapMetricSelectorCtrl', ['$log', '$debug', '$scope',
    function ($log, $debug, $scope) {
	  ...
	  if ($scope.selectedMetric)
            args.selectedMetric = $scope.selectedMetric;
	  if ($scope.selectedBenchmarkCategory)
            args.selectedBenchmarkCategory = $scope.selectedBenchmarkCategory;
        },
        loadValues: function(args){
	  if (args.selectedMetric)
            $scope.selectedMetric = args.selectedMetric;
	  if (args.selectedBenchmarkCategory)
            $scope.selectedBenchmarkCategory = args.selectedBenchmarkCategory;
        }
      });
