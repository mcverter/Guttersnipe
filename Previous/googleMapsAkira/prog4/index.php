 ...
 <script> window.dhx_globalImgPath = "anotherSlider/dhtmlxSlider/codebase/imgs/"; </script>
	...
	geocoder.geocode( 
		...
		downloadUrl("generateMarkers.php?" + GET_arg, function(data) 
				...
				refinementHTML = "<table border=\"1\" >\n\t<tr> <b> <td> select </td> <td> id </td> <td> name </td> <td> expense </td></b></tr>\n";    
				mstLen = 0;
				totalExpense = 0;
				...
				refinementHTML += "<p><h3> MST Distance : "   +  mstLen + "</h3></p>";
...
<script>
//slider 100-300, step 1;
var distanceAllowanceSlider = new dhtmlxSlider(null, 500, 'bar', false, 0, 250, <?php echo $distanceAllowance ?>, 1);
