let Resource = {
  thing: {
    ...
    taxonomy: {
      type: "medical",
      subtypes: ["Mental Health", "Emergency Medicine (Western) ", "Trans*"]
    },
    details: ["foo"],
    subtypeChosen: ["Mental Health", "Emergency Medicine (Western) ", "Trans*"]
  },
  place: {
    coordinates: {
      lat: 40.758895,
...
let floopyTwo = {
  thing: {
    description: {
      summary: "quackadacka doo",
      notes: "bs",
      headline: "macarena mania",
      method: "boo"
    },
    taxonomy: {
      type: "medical",
      subtypes: ["General Medicine (Western) ", "Emergency Medicine (Western) "]
    },
    details: ["flargen"]
  },
  place: {
    ...
    schedules: [
      {
        ...
        id: 1,
        allDay: false,
        start: "2015-04-08T13:00:00.000Z",
        end: "2015-04-08T13:30:00.000Z",
        __uiCalId: 1,
        _id: "1",
        _start: "2015-04-08T13:00:00.000Z",
        _end: "2015-04-08T13:30:00.000Z",
        className: []
      },
      {
        repeating: false,
        id: 1,
        allDay: false,
        start: "2015-04-09T14:30:00.000Z",
        end: "2015-04-09T15:00:00.000Z",
        __uiCalId: 2,
        _id: "1",
        _start: "2015-04-09T14:30:00.000Z",
        _end: "2015-04-09T15:00:00.000Z",
        className: []
      },
      {
        repeating: false,
        id: 1,
        allDay: false,
        start: "2015-04-10T13:00:00.000Z",
        end: "2015-04-10T13:30:00.000Z",
        __uiCalId: 3,
        _id: "1",
        _start: "2015-04-10T13:00:00.000Z",
        _end: "2015-04-10T13:30:00.000Z",
        className: []
      }
    ],
    notes: "floopy flop"
...
let requser = {
  provider: "local",
  username: "mcverter",
  _id: "550cd2a5b377f6540f9f0a4a",
  __v: "0",
  created: "Fri Mar 20 2015 22:08:37 GMT-0400 (EDT)",
  roles: "[ 'user' ]",
  email: "mitchell@moo.com"
};
let fromServer = {
...
let fumm = {
  ...
  time: {
    schedules: [
      { start: "2015-04-13T17:00:00.000Z", end: "2015-04-13T17:30:00.000Z" },
      { start: "2015-04-16T17:00:00.000Z", end: "2015-04-16T17:30:00.000Z" }
    ],
    notes: ""
  }
};
let bumm = {
  thing: {
    ...
    taxonomy: { type: "food", subtypes: ["Food Not Bombs"] },
    details: []
  },
  place: {
    coordinates: { lat: 40.758895, lng: -73.98513100000002 },
  ...
  time: {
    schedules: [
      { start: "2015-04-13T16:00:00.000Z", end: "2015-04-13T16:30:00.000Z" },
      { start: "2015-04-17T15:30:00.000Z", end: "2015-04-17T16:00:00.000Z" }
    ],
    notes: "forlorn"
  }
};
