              ...
              function (newValue) {
                ...
                if (newValue) {
                  $element.modal('show');
                   ...
                   // HACK: removeClass here is used to ensure that the modal and the backdrop are cleaned up properly.
                  // was having an issue where the backdrop would not be removed from the DOM because angular had modified the DOM
