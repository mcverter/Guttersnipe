/**
 * @class NovaData (Factory):
 * Returns an object
 *
 * Private
 * --------
 * @field novaDataFactory:  Returned object
 * @field dataCacheKey:  
 * @field dataCache : 
 * @field selections : 
 * @method toDataTable(tableData, propertyKeys):
 *
 * Public
 * --------
 *
 * @method setKey(key, val):
 * @method getKey()
 * @method data(reportPath, inputs)
 * @method dataPromise (reportPath, inputs)
 *
 * Extern
 * ------
 * $api.onLogout(): 
