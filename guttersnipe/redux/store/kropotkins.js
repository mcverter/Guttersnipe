...
const kropotkinDB =
  {
    "records": [
      ...
      {
        "id": 286,
        "paragraph": "Without, however, attaching to these forecasts a greater importance than they merit, we may safely conclude this much: the Revolution will take a different character in each of the different European nations; the point attained in the socialization of wealth will not be everywhere the same.    "
      },
      {
        "id": 287,
        "paragraph": "  Will it therefore be necessary, as is sometimes suggested, that the nations in the vanguard of the movement should adapt their pace to those who lag behind? Must we wait till the Communist Revolution is ripe in all civilized countries? Clearly not! Even if it were a thing to be desired, it is not possible. History does not wait for the laggards.    "
      },
      {
        "id": 288,
        "paragraph": "  Besides, we do not believe that in any one country the Revolution will be accomplished at a stroke, in the twinkling of an eye, as some socialists dream.[4] It is highly probable that if one of the five or six large towns of France--Paris, Lyons, Marseilles, Lille, Saint-Etienne, Bordeaux--were to proclaim the Commune, the others would follow its example, and that many smaller towns would do the same. Probably also various mining districts and industrial centres would hasten to rid themselves of \"owners\" and \"masters,\" and form themselves into free groups.    "
      },
      {
        "id": 323,
        "paragraph": "\"There are no barren lands; the earth is worth what man is worth\"--that is the last word of modern agriculture. Ask of the earth, and she will give you bread, provided that you ask aright.    "
      },
      {
        "id": 324,
        "paragraph": "  A district, though it were as small as the two departments of the Seine and the Seine-et-Oise, and with so great a city as Paris to feed, would be practically sufficient to grow upon it all the food supplies, which otherwise might fail to reach it.    "
      },
      {
        "id": 289,
        "paragraph": "  But many country places have not advanced to that point. Side by side with the revolutionized communes such places would remain in an expectant attitude, and would go on living on the Individualist system. Undisturbed by visits of the bailiff or the tax-collector, the peasants would not be hostile to the revolutionaries, and thus, while profiting by the new state of affairs, they would defer the settlement of accounts with the local exploiters. But with that practical enthusiasm which always characterizes agrarian uprisings (witness the passionate toil of 1792) they would throw themselves into the task of cultivating the land, which, freed from taxes and mortgages, would become so much dearer to them.    "
      },
      {
        "id": 290,
        "paragraph": "  As to other countries, revolution would break out everywhere, but revolution under divers aspects; in one country State Socialism, in another Federation; everywhere more or less Socialism, not conforming to any particular rule.    "
      },
      {
        "id": 306,
        "paragraph": "  All the great towns, we have said, buy their grain, their flour, and their meat, not only from the provinces, but also from abroad. Foreign countries send Paris not only spices, fish, and various dainties, but also immense quantities of corn and meat.    "
      },
      {
        "id": 499,
        "paragraph": "  We therefore propose to point out some of these most striking manifestations, and to show how men, as soon as their interests do not absolutely clash, act in concert, harmoniously, and perform collective work of a very complex nature.    "
      },
      {
        "id": 291,
        "paragraph": "  Let us now return to our city in revolt, and consider how its citizens can provide foodstuffs for themselves. How are the necessary provisions to be obtained if the nation as a whole has not accepted Communism? This is the question to be solved. Take, for example, one of the large French towns--take the capital itself, for that matter. Paris consumes every year thousands of tons of grain, 400,000 head of oxen, 300,000 calves, 400,000 swine, and more than two millions of sheep, besides great quantities of game. This huge city devours, besides, more than 20 million pounds of butter, 200 million eggs, and other produce in like proportion.    "
      },
      {
        "id": 292,
        "paragraph": "  It imports flour and grain from the United States and from Russia, Hungary, Italy, Egypt, and the Indies; live stock from Germany, Italy, Spain--even Roumania and Russia; and as for groceries, there is not a country in the world that it does not lay under contribution.    "
      },
      {
        "id": 293,
        "paragraph": "  Now, let us see how Paris or any other great town could be revictualled by home-grown produce, supplies of which could be readily and willingly sent in from the provinces.    "
      },
      {
        "id": 294,
      ...
      {
        "id": 615,
        "paragraph": "  As to the laziness of the great majority of workers, only philistine economists and philanthropists can utter such nonsense.    "
      },
      {
        "id": 616,
        "paragraph": "  If you ask an intelligent manufacturer, he will tell you that if workmen only put it into their heads to be lazy, all factories would have to be closed, for no measure of severity, no system of spying would be of any use. You should have seen the terror caused in 1887 among British employers when a few agitators started preaching the \"_go-canny_\" theory--\"Bad pay, bad work\"; \"Take it easy, do not overwork yourselves, and waste all you can.\"--\"They demoralize the worker, they want to kill our industry!\" cried those same people who the day before inveighed against the immorality of the worker and the bad quality of his work. But if the workers were what they are represented to be--namely, the idler whom the employer is supposed continually to threaten with dismissal from the workshop--what would the word \"demoralization\" signify?    "
      },
      {
        "id": 645,
        "paragraph": "Such is, in a few words, the organization the collectivists wish to see arise out of the Social Revolution. As we see, their principles are: Collective property of the instruments of production, and remuneration to each according to the time spent in producing, while taking into account the productivity of his labour. As to the political system, it would be the Parliamentary system, modified by _positive instructions_ given to those elected, and by the _Referendum_--a vote, taken by _noes_ or _ayes_ by the nation.    "
      },
      {
        "id": 646,
        "paragraph": "  Let us own that this system appears to us simply unrealizable.    "
      },
      {
        "id": 647,
        "paragraph": "  Collectivists begin by proclaiming a revolutionary principle--the abolition of private property--and then they deny it, no sooner than proclaimed, by upholding an organization of production and consumption which originated in private property.    "
      },
      {
        "id": 617,
      ...
      {
        "id": 668,
        "paragraph": "  This is why some collectivists, understanding the impossibility of maintaining a scale of wages in a society inspired by the breath of the Revolution, hasten to proclaim equality of wage. But they meet with new difficulties, and their equality of wages becomes the same unrealizable Utopia as the scale of wages of other collectivists.    "
      },
      {
        "id": 635,
        "paragraph": "  Neither is it astonishing that certain economists, more or less bourgeois, admit labour-cheques. They care little whether the worker is paid in labour-notes or in coin stamped with the effigy of the Republic or the Empire. They only care to save from destruction the individual ownership of dwelling-houses, of land, of factories; in any case--that, at least, of dwelling-houses and the capital that is necessary for manufacturing. And labour-notes would just answer the purpose of upholding this private property.    "
      },
      {
        "id": 636,
        "paragraph": "  As long as labour-notes can be exchanged for jewels or carriages, the owner of the house will willingly accept them for rent. And as long as dwelling houses, fields, and factories belong to isolated owners, men will have to pay these owners, in one way or another, for being allowed to work in the fields or factories, or for living in the houses. The owners will agree to be paid by the workers in gold, in paper-money, or in cheques exchangeable for all sorts of commodities, once that toll upon labour is maintained, and the right to levy it is left with them. But how can we defend labour-notes, this new form of wagedom, when we admit that the houses, the fields, and the factories will no longer be private property,--that they will belong to the commune or the nation?    "
      },
      {
        "id": 637,
        "paragraph": "  Let us closely examine this system of remuneration for work done, preached by the French, German, English, and Italian collectivists (the Spanish anarchists, who still call themselves collectivists, imply by Collectivism the possession in common of all instruments of production, and the \"liberty of each group to divide the produce, as they think fit, according to communist or any other principles\").    "
      },
      {
        "id": 638,
        "paragraph": "It amounts to this: Everybody works in field, factory, school, hospital, etc. The working-day is fixed by the State, which owns the land, the factories, the roads, etc. Every work-day is paid for with a _labour-note_, which is inscribed with these words: _Eight hours\" work_. With this cheque the worker can procure all sorts of merchandise in the stores owned by the State or by divers corporations. The cheque is divisible, so that you can buy an hour\"s-work worth of meat, ten minutes\" worth of matches, or half an hour of tobacco. After the Collectivist Revolution, instead of saying \"twopence worth of soap,\" we shall say \"five minutes\" worth of soap.\"    "
      },
      {
        "id": 639,
        "paragraph": "Most collectivists, true to the distinction laid down by middle-class economists (and by Marx as well) between _qualified_ work and _simple_ work, tell us, moreover, that _qualified_ or professional work must be paid a certain quantity more than _simple_ work. Thus one hour\"s work of a doctor will have to be considered as equivalent to two or three hours\" work of a hospital nurse, or to three or five hours\" work of a navvy. \"Professional, or qualified work, will be a multiple of simple work,\" says the collectivist Grönlund, \"because this kind of work needs a more or less long apprenticeship.\"    "
      },
      {
        "id": 640,
        "paragraph": "Some other collectivists, such as the French Marxist, Guesde, do not make this distinction. They proclaim the \"Equality of Wages.\" The doctor, the schoolmaster, and the professor will be paid (in labour-cheques) at the same rate as the navvy. Eight hours visiting the sick in a hospital will be worth the same as eight hours spent in earthworks or else in mines or factories.    "
      },
      {
        "id": 641,
        "paragraph": "  Some make a greater concession; they admit that disagreeable or unhealthy work--such as sewerage--could be paid for at a higher rate than agreeable work. One hour\"s work of a sewerman would be worth, they say, two hours of a professor\"s work.    "
      },
      {
        "id": 642,
        "paragraph": "  Let us add that certain collectivists admit of corporations being paid a lump sum for work done. Thus a corporation would say: \"Here are a hundred tons of steel. A hundred workmen were required to produce them, and it took them ten days. Their work-day being an eight-hours day, it has taken them eight thousand working hours to produce a hundred tons of steel--eight hours a ton.\" For this the State would pay them eight thousand labour-notes of one hour each, and these eight thousand cheques would be divided among the members of the iron-works as they themselves thought proper.    "
      },
      {
        "id": 643,
        "paragraph": "  On the other hand, a hundred miners having taken twenty days to extract eight thousand tons of coal, coal would be worth two hours a ton, and the sixteen thousand cheques of one hour each, received by the Guild of Miners, would be divided among their members according to their own appreciation.    "
      },
      {
        "id": 644,
        "paragraph": "  If the miners protested and said that a ton of steel should only cost six hours\" work instead of eight; if the professor wished to have his day paid four times more than the nurse, then the State would interfere and would settle their differences.    "
      },
      {
        "id": 648,
        "paragraph": "  They proclaim a revolutionary principle, and ignore the consequences that this principle will inevitably bring about. They forget that the very fact of abolishing individual property in the instruments of work--land, factories, road, capital--must launch society into absolutely new channels; must completely overthrow the present system of production, both in its aim as well as in its means; must modify daily relations between individuals, as soon as land, machinery, and all other instruments of production are considered common property.    "
      },
      {
        "id": 649,
        "paragraph": "  They say, \"No private property,\" and immediately after strive to maintain private property in its daily manifestations. \"You shall be a Commune as far as regards production: fields, tools, machinery, all that has been invented up till now--factories, railways, harbours, mines, etc., all are yours. Not the slightest distinction will be made concerning the share of each in this collective property.    "
      },
      {
        "id": 650,
        "paragraph": "\"But from to-morrow you will minutely debate the share you are going to take in the creation of new machinery, in the digging of new mines. You will carefully weigh what part of the new produce belongs to you. You will count your minutes of work, and you will take care that a minute of your neighbours should not buy more than yours.    "
      },
      {
        "id": 651,
        "paragraph": "\"And as an hour measures nothing, as in some factories a worker can see to six power-looms at a time, while in another he only tends two, you will weigh the muscular force, the brain energy, and the nervous energy you have expended. You will accurately calculate the years of apprenticeship in order to appraise the amount each will contribute to future production. And this--after having declared that you do not take into account his share in _past_ production.\"    "
      },
      {
        "id": 653,
      ...
      {
        "id": 849,
        "paragraph": "  And this is done now in Guernsey and Jersey on a very large scale, quite a number of steamers constantly plying between Guernsey and London, only to export the crops of the greenhouses.    "
      },
      {
        "id": 850,
        "paragraph": "  Nowadays, in order to obtain that same crop of 500 bushels of potatoes, we must plough every year a surface of four acres, plant it, cultivate it, weed, it, and so on; whereas with the glass, even if we shall have to give perhaps, to start with, half a day\"s work per square yard in order to build the greenhouse--we shall save afterwards at least one-half, and probably three-quarters of the yearly labour required formerly.    "
      },
      {
        "id": 851,
        "paragraph": "These are _facts_, results which every one can verify himself. And these facts are already a hint as to what man could obtain from the earth if he treated it with intelligence.    "
      },
      {
        "id": 852,
        "paragraph": "  In all the above we have reasoned upon what already withstood the test of experience. Intensive culture of the fields, irrigated meadows, the hot-house, and finally the kitchen garden under glass are realities. Moreover, the tendency is to extend and to generalize these methods of culture, because they allow of obtaining more produce with less work and with more certainty.    "
      },
      {
        "id": 853,
        "paragraph": "  In fact, after having studied the most simple glass shelters of Guernsey, we affirm that, taking all in all, far less work is expended for obtaining potatoes under glass in April, than in growing them in the open air, which requires digging a space four times as large, watering it, weeding it, etc. Work is likewise economized in employing a perfected tool or machine, even when an initial expense had to be incurred to buy the tool.    "
      },
      {
        "id": 854,
        "paragraph": "  Complete figures concerning the culture of common vegetables under glass are still wanting. This culture is of recent origin, and is only carried out on small areas. But we have already figures concerning the fifty years old culture of early season grapes, and these figures are conclusive.    "
      },
      {
        "id": 855,
        "paragraph": "  In the north of England, on the Scotch frontier, where coal only costs 3s. a ton at the pit\"s mouth, they have long since taken to growing hot-house grapes. Thirty years ago these grapes, ripe in January, were sold by the grower at 20s. per pound and resold at 40s. per pound for Napoleon III.\"s table. To-day the same grower sells them at only 2s. 6d. per pound. He tells us so himself in a horticultural journal. The fall in the prices is caused by the tons and tons of grapes arriving in January to London and Paris.    "
      },
      {
        "id": 856,
        "paragraph": "  Thanks to the cheapness of coal and an intelligent culture, grapes from the north travel now southwards, in a contrary direction to ordinary fruit. They cost so little that in May, English and Jersey grapes are sold at 1s. 8d. per pound by the gardeners, and yet this price, like that of 40s. thirty years ago, is only kept up by slack production.    "
      },
      {
        "id": 857,
